    ...
    (let [panel (proxy [JPanel] []
                  (paintComponent [^Graphics g]
                    ...
                    (let [g2 (.create ^Graphics2D g)
                          ...
                          ;; Calculate square tile size to fit full screen height
                          tile-size (min (int (/ w grid-cols)) (int (/ h grid-rows)))
                          grid-width (* grid-cols tile-size)
                          grid-height (* grid-rows tile-size)
                          offset-x (int (/ (- w grid-width) 2))
                          offset-y (int (/ (- h grid-height) 2))
                      ...
                      ;; Draw grid cells (top-to-bottom fill)
